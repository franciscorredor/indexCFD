...
/*
 * Obtener top 7 de compa�ias con mejor rentabilidad en el mercado! 
...
@NamedNativeQueries({
	//TODO --> encontrar la primera iteracion para saber si a superado el high del dia y del a�o, para dar un ponderado
